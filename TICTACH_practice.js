...
<div id="task-label" class="task-label hide-label"></div>
  ...
  <audio id="finish-audio" src="https://drive.google.com/uc?export=download&id=1uw-n2hN6A-jZVDQrq5E6n0-HdUVBuMPD"></audio>
    <p id="slider-text" style="display: none;">Try and sense your heartbeat without taking your pulse. You may close your eyes if this helps. When you feel ready, adjust the cartoon heart so that it matches your own internal heartbeat. Move the slider to the left to slow the heart or to the right to speed the heart up. Click finished when you are done. If you cannot feel your own heartbeat at all, click I cannot feel my heartbeat.</p>
<script>
...
let sliderClicked = false;
 ...
 if (!sliderClicked) {
  ...
  if (beatRateSlider.value === previousSliderValue) {
    resumeAnimation();
    animationPaused = false;
  }
